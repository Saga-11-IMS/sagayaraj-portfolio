    ...
    <section className="py-16 sm:py-24 bg-base relative overflow-hidden">
      ...
      <div ref={ref} className="mx-auto max-w-6xl px-5 sm:px-10 relative">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={v ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <p className="text-indigo font-semibold text-sm mb-2 tracking-wide uppercase">Hands-On</p>
          <h2 className="dark-text text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">DevOps & Cloud</h2>
          <div className="w-16 h-1 bg-amber rounded-full mb-4" />
          <p className="body-text text-sm sm:text-base lg:text-lg mb-8 sm:mb-10 max-w-lg">Hands-on experience with CI/CD, containerization, monitoring, and cloud-native tooling.</p>
        </motion.div>
